...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        Usuario user = new Usuario(null, "felipe@gmail.com", "123456", Role.ROLE_COORDENADOR);
        
        String password = new BCryptPasswordEncoder().encode(user.getSenha());
        Usuario new_user = new Usuario(null, user.getEmail(), password, Role.ROLE_ARTICULADOR);
